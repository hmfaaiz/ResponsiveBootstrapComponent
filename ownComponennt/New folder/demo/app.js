          ...
          <div class="container">
            <div class="row gy-3">
              ...
              <div class="col-lg-2 col-sm-4 col-4">
                <a href="https://therichpost.com/" target="_blank" class="display-6 float-start">
                  Ecommerce
                </a>
              </div>
              ...
              <div class="col-lg-5 col-md-12 col-12">
                <div class="input-group float-center">
                  <div class="form-outline">
                    ...
                    <label class="form-label" for="form1" style={{marginLeft: "0px"}}>Search</label>
          ...
          <div class="row gx-5">
            <aside class="col-lg-6">
              <div class="border rounded-4 mb-3 d-flex justify-content-center">
                <a data-fslightbox="mygalley" class="rounded-4" target="_blank" data-type="image" href="assets/images/big.webp">
                  <img style={{maxWidth: "100%", maxHeight: "100vh", margin: "auto"}} class="rounded-4 fit" src="assets/images/big.webp" />
                </a>
              </div>
              <div class="d-flex justify-content-center mb-3">
                <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="assets/images/big1.webp">
                  <img width="60" height="60" class="rounded-2" src="assets/images/big1.webp" />
                </a>
                <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="assets/images/big2.webp">
                  <img width="60" height="60" class="rounded-2" src="assets/images/big2.webp" />
                </a>
                <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="assets/images/big3.webp">
                  <img width="60" height="60" class="rounded-2" src="assets/images/big3.webp" />
                </a>
                <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="assets/images/big4.webp">
                  <img width="60" height="60" class="rounded-2" src="assets/images/big4.webp" />
                </a>
                <a data-fslightbox="mygalley" class="border mx-1 rounded-2" target="_blank" data-type="image" href="assets/images/big.webp">
                  <img width="60" height="60" class="rounded-2" src="assets/images/big.webp" />
                </a>
              </div>
            ...
            <div class="col-lg-8 mb-4">
              <div class="border rounded-2 px-3 py-2 bg-white">
                ...
                <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
                  ...
                  <li class="nav-item d-flex" role="presentation">
                    <a class="nav-link d-flex align-items-center justify-content-center w-100" id="ex1-tab-2" data-mdb-toggle="pill" href="#ex1-pills-2" role="tab" aria-controls="ex1-pills-2" aria-selected="false" tabindex="-1">Warranty info</a>
                  </li>
                  <li class="nav-item d-flex" role="presentation">
                    <a class="nav-link d-flex align-items-center justify-content-center w-100" id="ex1-tab-3" data-mdb-toggle="pill" href="#ex1-pills-3" role="tab" aria-controls="ex1-pills-3" aria-selected="false" tabindex="-1">Shipping info</a>
                  </li>
                  <li class="nav-item d-flex" role="presentation">
                    <a class="nav-link d-flex align-items-center justify-content-center w-100" id="ex1-tab-4" data-mdb-toggle="pill" href="#ex1-pills-4" role="tab" aria-controls="ex1-pills-4" aria-selected="false" tabindex="-1">Seller profile</a>
                  </li>
                </ul>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="d-flex mb-3">
                      <a href="#" class="me-3">
                        <img src="https://bootstrap-ecommerce.com/bootstrap5-ecommerce/images/items/8.webp" style={{miWidth: "96px", height: "96px"}} class="img-md img-thumbnail" />
                      </a>
                      <div class="info">
